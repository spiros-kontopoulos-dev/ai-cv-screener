        ...
        sections=(
            (
                ...
                (
                    ...
                    '--chunking-version NAME may be combined with any selection to label an in-memory experiment.',
                    '--max-characters N, --min-characters N, and --overlap-characters N may be combined to inspect temporary chunk-size settings.',
            ...
            (
                ...
                (
                    ...
                    'python -m app.scripts.inspect_cv_chunks --file data/imports/cv.pdf --candidate-id candidate_031 --candidate-name "Alex Morgan" --professional-title "Python Engineer"',
                    'python -m app.scripts.inspect_cv_chunks --all --chunking-version cv-sections-experiment --max-characters 1200 --min-characters 350 --overlap-characters 120',
                ),
            ),
        ),
    )
